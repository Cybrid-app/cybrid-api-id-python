...
class GroupAuthorization(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'guid': (str,),  # noqa: E501
            'group_guid': (str,),  # noqa: E501
            'resource_guid': (str,),  # noqa: E501
    ...
    attribute_map = {
        'guid': 'guid',  # noqa: E501
        'group_guid': 'group_guid',  # noqa: E501
        'resource_guid': 'resource_guid',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, group_guid, resource_guid, resource_type, allowed_scopes, created_at, *args, **kwargs):  # noqa: E501
        """GroupAuthorization - a model defined in OpenAPI

        Args:
            guid (str): The group authorization's guid.
            group_guid (str): Guid of the group.
            resource_guid (str): Guid of the organization linked to the group.
            resource_type (str): Type of the linked resource.
            allowed_scopes ([str]): Scopes the group holds over the organization.
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, group_guid, resource_guid, resource_type, allowed_scopes, created_at, *args, **kwargs):  # noqa: E501
        """GroupAuthorization - a model defined in OpenAPI
