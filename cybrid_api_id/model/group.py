...
class Group(ModelNormal):
    ...
    attribute_map = {
        ...
        'name': 'name',  # noqa: E501
        'type': 'type',  # noqa: E501
        'member_guids': 'member_guids',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, guid, name, type, member_guids, created_at, *args, **kwargs):  # noqa: E501
        """Group - a model defined in OpenAPI

        Args:
            guid (str): The group's guid.
            name (str): Name provided for the group.
            type (str): Type of the group.
            member_guids ([str]): Guids of the users who are members of the group.
        ...
        self.name = name
        self.type = type
        self.member_guids = member_guids
    ...
    @convert_js_args_to_python_args
    def __init__(self, guid, name, type, member_guids, created_at, *args, **kwargs):  # noqa: E501
        """Group - a model defined in OpenAPI
