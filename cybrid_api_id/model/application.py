...
class Application(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, client_id, scopes, ip_allowlist, created_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, client_id, scopes, ip_allowlist, created_at, *args, **kwargs):  # noqa: E501
        """Application - a model defined in OpenAPI
