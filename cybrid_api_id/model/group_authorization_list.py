...
def lazy_import():
    ...
    globals()['GroupAuthorization'] = GroupAuthorization


class GroupAuthorizationList(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'objects': ([GroupAuthorization],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, total, page, per_page, objects, *args, **kwargs):  # noqa: E501
        """GroupAuthorizationList - a model defined in OpenAPI
