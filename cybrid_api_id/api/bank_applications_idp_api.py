...
class BankApplicationsIdpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_bank_application_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/bank_applications/{client_id}',
                'operation_id': 'get_bank_application',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_bank_application_endpoint = _Endpoint(
            settings={
                'response_type': (Application,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/bank_applications/{client_id}',
                'operation_id': 'update_bank_application',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def get_bank_application(
        self,
        client_id,
        **kwargs
    ):
        """Get bank application  # noqa: E501

        Retrieves a bank application.  Required scope: **bank_applications:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_bank_application(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.get_bank_application_endpoint.call_with_http_info(**kwargs)
    ...
    def update_bank_application(
        self,
        client_id,
        patch_application,
        **kwargs
    ):
        """Update bank application  # noqa: E501

        Updates a bank application.  Required scope: **bank_applications:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_bank_application(client_id, patch_application, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['patch_application'] = \
            patch_application
        return self.update_bank_application_endpoint.call_with_http_info(**kwargs)
