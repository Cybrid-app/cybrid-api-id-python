...
class OrganizationApplicationsIdpApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_organization_application_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/api/organization_applications/{client_id}',
                'operation_id': 'get_organization_application',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.update_organization_application_endpoint = _Endpoint(
            settings={
                'response_type': (Application,),
                'auth': [
                    'BearerAuth',
                ...
                'endpoint_path': '/api/organization_applications/{client_id}',
                'operation_id': 'update_organization_application',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def get_organization_application(
        self,
        client_id,
        **kwargs
    ):
        """Get organization application  # noqa: E501

        Retrieves an organization application.  Required scope: **organization_applications:read**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_organization_application(client_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        return self.get_organization_application_endpoint.call_with_http_info(**kwargs)
    ...
    def update_organization_application(
        ...
        **kwargs
        ...
        """Update organization application  # noqa: E501

        Updates an organization application.  Required scope: **organization_applications:write**  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_organization_application(client_id, patch_application, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['client_id'] = \
            client_id
        kwargs['patch_application'] = \
            patch_application
        return self.update_organization_application_endpoint.call_with_http_info(**kwargs)
