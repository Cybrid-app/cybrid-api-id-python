...
*BankApplicationsIdpApi* | [**get_bank_application**](docs/BankApplicationsIdpApi.md#get_bank_application) | **GET** /api/bank_applications/{client_id} | Get bank application
...
*BankApplicationsIdpApi* | [**update_bank_application**](docs/BankApplicationsIdpApi.md#update_bank_application) | **PATCH** /api/bank_applications/{client_id} | Update bank application
...
*OrganizationApplicationsIdpApi* | [**get_organization_application**](docs/OrganizationApplicationsIdpApi.md#get_organization_application) | **GET** /api/organization_applications/{client_id} | Get organization application
...
*OrganizationApplicationsIdpApi* | [**update_organization_application**](docs/OrganizationApplicationsIdpApi.md#update_organization_application) | **PATCH** /api/organization_applications/{client_id} | Update organization application
...
## Documentation For Models
 ...
 - [Group](docs/Group.md)
 - [GroupAuthorization](docs/GroupAuthorization.md)
 - [GroupAuthorizationList](docs/GroupAuthorizationList.md)
 - [GroupList](docs/GroupList.md)
 - [ListRequestPage](docs/ListRequestPage.md)
 - [ListRequestPerPage](docs/ListRequestPerPage.md)
 - [PatchApplication](docs/PatchApplication.md)
